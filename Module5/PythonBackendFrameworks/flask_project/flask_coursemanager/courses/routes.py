...
from Module5.PythonBackendFrameworks.flask_project.flask_coursemanager.extensions import db
from Module5.PythonBackendFrameworks.flask_project.flask_coursemanager.courses.models import Department, Student, Course, Enrollment
